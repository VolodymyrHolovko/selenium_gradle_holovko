...
public class SchedulesElementsLocator {
    ...
    String selectWorkersScheduleType = "/html/body/app/ui-view/div/ui-view/working-days/div/md-tabs/md-tabs-content-wrapper/md-tab-content[2]/div/div/div[2]/div/div[1]/md-select/md-select-value/span[1]/div/span";
