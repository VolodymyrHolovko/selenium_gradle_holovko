...
public class SchedulesElementsLocator {
    ...
    String selectWorkersScheduleType = "/html/body/app/ui-view/div/ui-view/working-days/div/md-tabs/md-tabs-content-wrapper/md-tab-content[2]/div/div/div[2]/div/div[1]/div/md-select/md-select-value/span[1]";
    ...
    String checkSaturdayOnCalendarIsFree= "//*/div/div/div[2]/working-days-settings-recurrence/working-days-settings-recurrence-calendar/div[2]/div/div[3]/div[6]";
    String checkSandayOnCalendarIsFree= "//*/div/div/div[2]/working-days-settings-recurrence/working-days-settings-recurrence-calendar/div[2]/div/div[3]/div[6]";
    String swicherAtRegularSchedule = "/html/body/app/ui-view/div/ui-view/working-days/div/md-tabs/md-tabs-content-wrapper/md-tab-content[2]/div/div/div[2]/working-days-settings-regular/working-days-settings-regular-slot[1]/div[1]/div/div/md-switch/div[1]/div[1]";
    ...
    String choseeDovilnuyDay = "//*/div/div/div[2]/working-days-settings-custom/working-days-settings-custom-calendar/div[2]/div/div[3]/div[4]/div";
